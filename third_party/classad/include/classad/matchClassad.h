...
/**
  add in 2010-7-21
  return true if the Requirements of ClassAd my if satisfied. 
 */
bool IsAHalfMatch(ClassAd *my, ClassAd *target);
/**
   add in 2010-7-21
   return true if the Requirements of ClassAd ad1 and ClassAd ad2 are satisfied.
  */
bool IsAMatch(ClassAd *ad1, ClassAd *ad2 );
std::string adToString(const ClassAd * ad);
std::string adToPrettyString(const ClassAd * ad);
