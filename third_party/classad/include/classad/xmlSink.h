...
class ClassAdXMLUnParser
{
 public:
    ...
    void AddAttrStartTag(std::string &buffer, const char *name);
    void AddTag(std::string &buffer, XMLLexer::TagID tag_id,
                        bool start_type );
    void AddXMLFileHeader(std::string &buffer);
    void AddXMLFileFooter(std::string &buffer);
