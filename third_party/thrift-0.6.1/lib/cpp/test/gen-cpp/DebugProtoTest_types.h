...
typedef struct _OneOfEach__isset {
  _OneOfEach__isset() : im_true(false), im_false(false), a_bite(false), integer16(false), integer32(false), integer64(false), double_precision(false), some_characters(false), zomg_unicode(false), what_who(false), base64(false), byte_list(false), i16_list(false), i64_list(false) {}
  bool im_true;
  bool im_false;
  bool a_bite;
  bool integer16;
