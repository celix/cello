...
class ServiceForExceptionWithAMapProcessor : virtual public ::apache::thrift::TProcessor {
 ...
 private:
  std::map<std::string, void (ServiceForExceptionWithAMapProcessor::*)(int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*, void*)> processMap_;
