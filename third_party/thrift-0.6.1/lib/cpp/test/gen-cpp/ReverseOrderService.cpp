...
bool ReverseOrderServiceProcessor::process(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot, void* callContext) {
...
bool ReverseOrderServiceProcessor::process_fn(::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, std::string& fname, int32_t seqid, void* callContext) {
  std::map<std::string, void (ReverseOrderServiceProcessor::*)(int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*, void*)>::iterator pfn;
...
void ReverseOrderServiceProcessor::process_myMethod(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("ReverseOrderService.myMethod", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "ReverseOrderService.myMethod");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "ReverseOrderService.myMethod");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "ReverseOrderService.myMethod", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "ReverseOrderService.myMethod");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "ReverseOrderService.myMethod");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "ReverseOrderService.myMethod", bytes);
  }
}
