    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->blah = (SomeEnum::type)ecast574;
          this->__isset.blah = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->enum_field = (SomeEnum::type)ecast580;
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            iprot->readSetBegin(_etype584, _size581);
            uint32_t _i585;
            for (_i585 = 0; _i585 < _size581; ++_i585)
            {
              int32_t _elem586;
              xfer += iprot->readI32(_elem586);
              this->i32_set.insert(_elem586);
            }
            iprot->readSetEnd();
          }
          this->__isset.i32_set = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype588, _vtype589, _size587);
            uint32_t _i591;
            for (_i591 = 0; _i591 < _size587; ++_i591)
            {
              int32_t _key592;
              xfer += iprot->readI32(_key592);
              int32_t& _val593 = this->i32_map[_key592];
              xfer += iprot->readI32(_val593);
            }
            iprot->readMapEnd();
          }
...
uint32_t TestUnion::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, this->struct_list.size());
    std::vector<RandomStuff> ::const_iterator _iter594;
    for (_iter594 = this->struct_list.begin(); _iter594 != this->struct_list.end(); ++_iter594)
    {
  ...
  {
    xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_I32, this->i32_set.size());
    std::set<int32_t> ::const_iterator _iter595;
    for (_iter595 = this->i32_set.begin(); _iter595 != this->i32_set.end(); ++_iter595)
    {
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_I32, this->i32_map.size());
    std::map<int32_t, int32_t> ::const_iterator _iter596;
    for (_iter596 = this->i32_map.begin(); _iter596 != this->i32_map.end(); ++_iter596)
    {
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->struct_list.resize(_size597);
            uint32_t _i601;
            for (_i601 = 0; _i601 < _size597; ++_i601)
            {
              xfer += this->struct_list[_i601].read(iprot);
            }
            iprot->readListEnd();
          }
          this->__isset.struct_list = true;
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->enum_field = (SomeEnum::type)ecast602;
          this->__isset.enum_field = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            iprot->readSetBegin(_etype606, _size603);
            uint32_t _i607;
            for (_i607 = 0; _i607 < _size603; ++_i607)
            {
              int32_t _elem608;
              xfer += iprot->readI32(_elem608);
              this->i32_set.insert(_elem608);
            }
            iprot->readSetEnd();
          }
          this->__isset.i32_set = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype610, _vtype611, _size609);
            uint32_t _i613;
            for (_i613 = 0; _i613 < _size609; ++_i613)
            {
              int32_t _key614;
              xfer += iprot->readI32(_key614);
              int32_t& _val615 = this->i32_map[_key614];
...
uint32_t TestUnionMinusStringField::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, this->struct_list.size());
    std::vector<RandomStuff> ::const_iterator _iter616;
    for (_iter616 = this->struct_list.begin(); _iter616 != this->struct_list.end(); ++_iter616)
    {
  ...
  {
    xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_I32, this->i32_set.size());
    std::set<int32_t> ::const_iterator _iter617;
    for (_iter617 = this->i32_set.begin(); _iter617 != this->i32_set.end(); ++_iter617)
    {
  ...
  xfer += oprot->writeFieldBegin("i32_map", ::apache::thrift::protocol::T_MAP, 8);
  {
    ...
    for (_iter618 = this->i32_map.begin(); _iter618 != this->i32_map.end(); ++_iter618)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype620, _vtype621, _size619);
            uint32_t _i623;
            for (_i623 = 0; _i623 < _size619; ++_i623)
            {
              int32_t _key624;
              xfer += iprot->readI32(_key624);
              int32_t& _val625 = this->somemap_field[_key624];
              xfer += iprot->readI32(_val625);
            }
            iprot->readMapEnd();
          }
...
uint32_t StructWithASomemap::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("somemap_field", ::apache::thrift::protocol::T_MAP, 1);
  {
    ...
    std::map<int32_t, int32_t> ::const_iterator _iter626;
    for (_iter626 = this->somemap_field.begin(); _iter626 != this->somemap_field.end(); ++_iter626)
    {
      xfer += oprot->writeI32(_iter626->first);
      xfer += oprot->writeI32(_iter626->second);
    }
    xfer += oprot->writeMapEnd();
  }
  xfer += oprot->writeFieldEnd();
