...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Thrift/HttpClient.pm blib/lib/Thrift/BinaryProtocol.pm blib/lib/Thrift/Protocol.pm blib/lib/Thrift/Transport.pm blib/lib/Thrift/BufferedTransport.pm $(MAKEFILE_OLD)
	$(RM_F) blib/lib/Thrift/MemoryBuffer.pm blib/lib/Thrift/FramedTransport.pm blib/lib/Thrift.pm blib/lib/Thrift/Socket.pm $(FIRST_MAKEFILE) blib/lib/Thrift/Server.pm
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Thrift' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.6.1' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Thrift.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Bit::Vector:                   0' >> META.yml
...
ppd:
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,6,1,0">' > $(DISTNAME).ppd
