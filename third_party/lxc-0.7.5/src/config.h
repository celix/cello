...
/* lxc-init directory location */
#define LXCINITDIR "/usr/local/lib/lxc"

/* lxc configuration repository */
#define LXCPATH "/usr/local/var/lib/lxc"

/* lxc default rootfs mount point */
#define LXCROOTFSMOUNT "/usr/local/lib/lxc/rootfs"
...
#define PACKAGE_STRING "lxc 0.7.5"
